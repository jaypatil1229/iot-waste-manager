  ...
  return (
    <div>
      <div className="account-info flex justify-between items-center">
        <h1 className="text-3xl font-semibold">Welcome, {session.user.name.split(' ')[0]}👋🏻</h1>
        <div className="profile-container flex gap-4 items-center">
          <div className="profile min-w-36 p-1 flex items-center rounded-full border border-slate-400 gap-2">
            <Image
